...
export const Home: React.FC = () => {
  ...
  return (
    <div className="overflow-hidden">
      {/* Hero Section */}
      <section className="relative pt-20 pb-32 bg-gradient-to-b from-primary-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-100 text-primary-700 text-sm font-medium mb-8 animate-fade-in-up">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 tracking-tight mb-6 animate-fade-in-up-delay-1 opacity-0">
            One QR. <span className="text-primary-600">Any File.</span> <br />
            Secure Sharing.
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up-delay-2 opacity-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up-delay-2 opacity-0">
            <Link to="/login" className="bg-primary-600 hover:bg-primary-700 text-white px-8 py-4 rounded-xl text-lg font-semibold shadow-lg shadow-primary-200 transition-all hover:-translate-y-1 hover:shadow-xl">
              Get Started Free (1 GB)
            </Link>
            <Link to="/pricing" className="bg-white hover:bg-gray-50 text-gray-900 border border-gray-200 px-8 py-4 rounded-xl text-lg font-semibold transition-all hover:-translate-y-1">
              View Pricing
            </Link>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 mt-2">Share anything in 3 simple steps</p>
          </div>
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="relative group p-8 rounded-2xl bg-gray-50 hover:bg-white hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-primary-100 top-0 hover:-top-2">
                <div className="w-16 h-16 bg-white rounded-xl shadow-sm flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-primary-50 transition-all duration-300">
                  {step.icon}
                </div>
      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        {/* Decorative Circles */}
        <div className="absolute top-10 left-10 w-32 h-32 rounded-full border-4 border-primary-100 opacity-50 animate-float"></div>
        <div className="absolute bottom-10 right-10 w-24 h-24 rounded-full bg-primary-100 opacity-30 animate-float-delayed"></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900">Built for Everyone</h2>
            <p className="text-gray-500 mt-2">See how QR Vault helps different industries</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
             <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">Instantly update digital menus without re-printing QR stickers. Upload new PDFs and the QR stays the same.</p>
             </div>
             <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">Share property floor plans, legal docs, and virtual tour links in one scan during open houses.</p>
             </div>
             <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">Teachers can bundle assignment PDFs, resource links, and example images into a single code for students.</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">Trusted by 10,000+ Users</h2>
              <p className="text-xl text-gray-500">See why people love using QR Vault.</p>
           </div>
           ...
           <div className="grid md:grid-cols-3 gap-8">
              {[
                  ...
                  <div key={i} className="group relative bg-white p-8 rounded-3xl shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:-translate-y-2">
                      <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity">
                         <Quote className="w-16 h-16 text-primary-600 transform rotate-12" />
                      </div>
                      ...
                      <p className="text-gray-700 text-lg leading-relaxed mb-8 relative z-10 font-medium">"{t.quote}"</p>
