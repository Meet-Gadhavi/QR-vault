...
| **Vault Lifecycle** | **Expiration Rules**: Auto-expire by date or scan count. | **Permanent Storage** (Optional Expiry date/scan count) |
...
## 2. Upcoming & Missing Features

These features are essential to fill gaps in the current user experience:

- **[MISSING] Bulk Download**: A "Download All as .ZIP" button on the public view page.
