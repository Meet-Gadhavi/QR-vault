...
const LegalLayout: React.FC<{ title: string; children: React.ReactNode }> = ({ title, children }) => (
  <div className="max-w-4xl mx-auto px-4 py-16 dark:bg-[#0a0a0a] transition-colors duration-300">
    ...
    <div className="prose prose-slate dark:prose-invert max-w-none text-gray-600 dark:text-gray-400 space-y-6">
      {children}
    </div>
  </div>
);
  ...
  <LegalLayout title="Privacy Policy">
    ...
    <section>
      ...
      <div className="ml-4 space-y-4 mt-2">
        ...
        <div>
          <h3 className="font-semibold text-gray-800 dark:text-gray-200">User Content</h3>
          <ul className="list-disc ml-5">
        ...
        <div>
          <h3 className="font-semibold text-gray-800 dark:text-gray-200">Payment Information</h3>
    ...
    <section>
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">3. Cookies and Tracking Technologies</h2>
    ...
    <section>
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">5. Data Storage and Security</h2>
    ...
    <section>
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">7. Contact Information</h2>
...
export const Terms: React.FC = () => (
  <LegalLayout title="Terms & Conditions">
    ...
    <section>
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">2. User Responsibilities</h2>
    ...
    <section>
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">3. Acceptable Usage</h2>
    ...
    <section>
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">5. Subscription Terms</h2>
    ...
    <section>
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">6. Account Suspension or Termination</h2>
...
export const RefundPolicy: React.FC = () => (
  <LegalLayout title="Refund & Cancellation Policy">
    ...
    <section>
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">1. Refund Eligibility</h2>
      <p>Users may request a refund within 7 days of purchase if the service has not been significantly used.</p>
    </section>

    <section>
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">2. Non-Refundable Situations</h2>
    ...
    <section>
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">3. Cancellation</h2>
    ...
    <section>
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">4. Refund Processing</h2>
